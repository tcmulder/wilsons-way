 ...
 * @param {boolean} props.middle Whether to center the content vertically.
 ...
 */
export const Page = ({ children, fullWidth = false, middle = false, className = '', style, ref = null }) => {
	const classNames = [
		'sr-page',
		className,
		fullWidth ? 'sr-page--full-width' : '',
		middle ? 'sr-page--middle' : '',
	];
	return (
