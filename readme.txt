...
* Fix mobile orientation styling issue.
...
* Safeguard team name selections.
* Enhance countdown.

= 2.5.4 =

* Support password protection for the template.

= 2.5.3 =

* Compress levels.
* Apply various minor bug fixes.

= 2.5.2 =

* Fix falling-through-shelf bug.
...
* Add all levels.
* Add transitionary pages between levels.
